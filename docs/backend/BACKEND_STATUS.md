...
| Database schema               | Done        | `packages/db/prisma/schema.prisma`                 | 8 models; migrations `0001_init`, `0002_files`                        |
| Metrics                       | Done        | `apps/api/src/plugins/metrics.ts`                  | Prometheus text format                                                |
| Thumbnails / derivatives      | Not started | —                                                  | Needs `apps/worker` + a job queue (roadmap P6)                        |
...
| AI / chat backend             | Not started | —                                                  | `CHAT_BACKEND.md`, `FUTURE_AI_BACKEND.md`; roadmap P9                 |
| Tool runner (SpiderFoot etc)  | Not started | —                                                  | `RAVEN-SPEC/10_INTEGRATIONS.md`; roadmap P7                           |
