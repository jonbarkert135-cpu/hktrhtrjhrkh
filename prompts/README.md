...
| `PROMPT_2_UNIFIED_INTELLIGENCE_PLATFORM_RU.md`   | Layer 2: ecosystem + competitor audit and the unified query/orchestration layer above the engines. | Designed — `RAVEN-SPEC/21`, `22`, `23`; implemented by phase **P17**. |
